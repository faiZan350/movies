...
USERNAME = environ.get('USERNAME', "@IKD_mark") # ADMIN USERNAME
LOG_CHANNEL = int(environ.get('LOG_CHANNEL', '-1002262392996'))
MOVIE_GROUP_LINK = environ.get('MOVIE_GROUP_LINK', '@FKmoviebot')
CHANNELS = [int(ch) if id_pattern.search(ch) else ch for ch in environ.get('CHANNELS', '-1002356132564').split()]
#---------------------------------------------------------------
#---------------------------------------------------------------
DATABASE_URI = environ.get('DATABASE_URI', "mongodb+srv://faizanmark95:@faizanq.cnd6u.mongodb.net/?retryWrites=true&w=majority&appName=Faizanq")
